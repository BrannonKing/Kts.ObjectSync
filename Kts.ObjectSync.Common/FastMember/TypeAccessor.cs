...
namespace FastMember
{
    ...
    public abstract class TypeAccessor
    {
        ...
        public static TypeAccessor Create(Type type, bool allowNonPublicAccessors)
        {
            ...
            var obj = lookup[type];
            if (obj != null) return (TypeAccessor) obj;
        ...
        static TypeAccessor CreateNew(Type type, bool allowNonPublicAccessors)
        {
            ...
            if (!IsFullyPublic(type, props, allowNonPublicAccessors))
            {
                ...
                return new DelegateAccessor(
                    ...
                    (Func<object>) dynCtor?.CreateDelegate(typeof(Func<object>)), type);
            }
            ...
            MethodBuilder body = tb.DefineMethod(baseGetter.Name, baseGetter.Attributes & ~MethodAttributes.Abstract, typeof(object), new[] { typeof(object), typeof(string) });
